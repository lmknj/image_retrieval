...
class ImageCollector(tk.Frame):
    ...
    def create_entry(self):
        ...
        self.frame.pack()
        self.label = tk.Label(
            self.frame, text='Input what you download.', font=('consolas', 12), height=2)
        self.label.pack()
    ...
    def create_slider(self):
        ...
        self.label = tk.Label(
            self.frame, text='Input how many images you download.', font=('consolas', 12), height=2)
        self.label.pack()
    ...
    def create_button(self):
        ...
        self.label = tk.Label(
            self.frame, text='Select download directory.', font=('consolas', 12), height=2)
        self.label.pack()
    ...
    def create_execute(self):
        ...
        self.frame_exe.pack()
        self.button = tk.Button(
            self.frame_exe, text='execute', bg='#00ffff', command=self.download)
        self.button.pack()
